...
ANFScene::ANFScene(char *filename)
{
	...
	// Check if there was no error in the file handling
	if ( !loadOkay )
	{
	...
	// Create the first TiXmlElement, <anf>
	TiXmlElement* anfElement= doc->FirstChildElement( "anf" );

	// Verify if the file has an ANF block
	if (anfElement == NULL)
	{
	...
	appearencesElement =  anfElement->FirstChildElement( "appearences" );
